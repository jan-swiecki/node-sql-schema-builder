module.exports = Autowire(function(_, uuid, Promise, Type) {
  ...
  function FieldValidator(fieldProperties, value, optionalName) {
    ...
    //  if(_.isNull(value)) {
    //    if(column.isNotNull()) {
    //      return reject("value cannot be null");
    //    } else {
    //      return resolve();
    //    }
    //  }
    ...
    //  // -- below this line value is not null --
    //
    //  if(column.type.is(Type.UUID)) {
    //    rejectIfNotString();
    //    finish(
    //      value.match(/[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89aAbB][a-f0-9]{3}-[a-f0-9]{12}/),
    //      "value is not in the UUID format"
    //    );
    //  } else if(column.type.is(Type.VARCHAR)) {
    //    rejectIfNotString();
    //
    //  }
    //
    //  reject("encountered unknown type during validation: \""+column.type.name+"\"");
    //
    //  function rejectIf(check, errorMsg) {
    //    if(! check) {
    //      reject(errorMsg);
    //    }
    //  }
  ...
  //function Validator(type, validatorFunction) {
  ...
  //}
  //
  //Validator.prototype.setType = function(type) {
  //  this.type = type;
  //  return this;
  //};
  //
  //Validator.prototype.getType = function(type) {
  //  return this.type;
  //};
  //
  //Validator.prototype.setValidatorFunction = function(validatorFunction) {
  //  this.validatorFunction = validatorFunction;
  //  return this;
  //};
  //
  //Validator.prototype.getValidatorFunction = function(validatorFunction) {
