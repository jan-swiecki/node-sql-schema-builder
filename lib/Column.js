module.exports = Autowire(function(_, util){
  ...
  /**
   * Returns validation properties for this column. Returned object
   * is compatible with FieldValidator.
   *
   * See FieldValidator for properties object definition.
   *
   * @returns {{isNull: boolean, isUnique: boolean, hasLength: *}}
   */
